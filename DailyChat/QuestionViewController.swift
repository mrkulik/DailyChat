...
final class QuestionViewController: JSQMessagesViewController {
    ...
    private lazy var userIsTypingRef: DatabaseReference = self.questionRef!.child("typingIndicator").child(self.senderId)
    private lazy var usersTypingQuery: DatabaseQuery = self.questionRef!.child("typingIndicator").queryOrderedByValue().queryEqual(toValue: true)
    ...
    private func observeTyping() {
        let typingIndicatorRef = questionRef!.child("typingIndicator")
